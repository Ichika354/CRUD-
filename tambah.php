        ...
        <form action="" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="number" placeholder="isi gaji" name="gaji" id="gaji" require class="form-control"></td>
                </tr>
                <tr>
                    <td><label for="alamat">Alamat</label></td>
                    <td>:</td>
                    <td><input type="text" placeholder="isi alamat" name="alamat" id="alamat" require class="form-control"></td>
                </tr>
                <tr>
