        ...
        <form action="" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="number" placeholder="isi gaji" name="gaji" id="gaji" required class="form-control" value="<?= $pegawai["data_gaji"] ?>"></td>
                </tr>
                <tr>
                    <td><label for="alamat">Alamat</label></td>
                    <td>:</td>
                    <td><input type="text" placeholder="isi alamat" name="alamat" id="alamat" required class="form-control" value="<?= $pegawai["alamat"] ?>"></td>
                </tr>
                <tr>
